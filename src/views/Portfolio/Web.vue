  ...
  metaInfo: {
    ...
    meta: [
      { name: "viewport", content: "width=device-width, initial-scale=1" },
      {
        name: "description",
        content:
          "christian Zaimovic's Web Portfolio Vue Vue.js Nuxt Nuxt.js HTML CSS Vuetify Axios GraphQL JavaScript Web Developer Front-End Frontend Designer App Responsive"
      },
      { charset: "utf-8" },
      ...
      projects: [
         {
          ...
          poster: "https://imgur.com/Xj3O8A3"
        },
        {
          dialog: false,
          title: "CBOO",
          git: "",
          demo: "https://cps.bsu-info.tech/",
          tech: {
            tech1: "PHP",
            tech2: "JavaScript",
            tech3: "HTML",
          ...
          poster: "https://imgur.com/ZzLW7wD"
        },
      ]
    };
  }
